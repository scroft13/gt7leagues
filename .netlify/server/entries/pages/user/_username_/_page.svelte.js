import { c as create_ssr_component, a as add_attribute, e as escape, d as subscribe, v as validate_component, f as each } from "../../../../chunks/index3.js";
import "../../../../chunks/db.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${``}
<div class="mx-4 lg:mx-16 xl:mx-40"><div class="flex justify-center items-center gap-x-8"><div class="relative">${`<div class="bg-gray-200 rounded-full w-20 h-20">${validate_component(Fa, "Fa").$$render(
    $$result,
    {
      icon: faUser,
      scale: 3,
    ...
    {}
      ...
      <div class="absolute -top-3 -right-3">${data.isCurrentUser ? `<button>${validate_component(Fa, "Fa").$$render($$result, { icon: faPaintbrush, primaryColor: "gray" }, {}, {})}</button>` : ``}</div></div>
    <p>${escape($storedUser?.username)}</p></div>
  <div><p>Current Leagues</p>
    ${each(leagues, (league) => {
    return `<a${add_attribute("href", "/league/" + league.leagueLink, 0)}>${escape(league.leagueName)}</a>`;
  })}</div></div>`;
});
export {
  Page as default
